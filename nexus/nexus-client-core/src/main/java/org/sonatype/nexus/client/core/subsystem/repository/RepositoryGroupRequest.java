...
public class RepositoryGroupRequest {
  ...
  public RepositoryGroupRequest(String id, String name, String provider, boolean exposed, List<String> memberRepositoryIds) {
    this.id = id;
    this.name = name;
