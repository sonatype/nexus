 ...
 * @since 2.3
 */
public class RepositoryItemBatchEventAddedToGroup
    extends RepositoryItemBatchEventAdded
{
     ...
     * @param itemPaths
     */
    public RepositoryItemBatchEventAddedToGroup( final GroupRepository group, final Repository contributor,
