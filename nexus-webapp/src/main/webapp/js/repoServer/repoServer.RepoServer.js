    ...
    addNexusNavigationItems: function( nexusPanel ) {      
      ...
      nexusPanel.add( {
        ...
        items: [
          ...
          { title: 'Nexus Book',
            href: 'http://www.sonatype.com/books/nexus-book/reference/' },
          { title: 'Nexus Screencasts',
            href: 'http://www.sonatype.com/products/nexus/documentation/screencasts' },
          { title: 'Nexus Blogs',
            href: 'http://www.sonatype.com/people/category/nexus/' },
          { title: 'Nexus Wiki',
            href: 'https://docs.sonatype.com/display/NX/Home' },
          { title: 'Maven Book',
            href: 'http://www.sonatype.com/documentation/books/maven-defguide' },
          { title: 'Release Notes',
